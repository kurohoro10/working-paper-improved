{{-- Sole Trader Section Partial - working-papers/partials/soleTrader-section.blade.php --}}

<div class="space-y-6" x-data="soleTraderSection({{ $section->id }})">
    {{-- Quarter Tabs --}}
    ...
    <div>
        <div class="flex justify-between items-center mb-3">
            ...
            <button type="button"
                    ...
                    class="text-sm text-purple-600 hover:text-purple-700 font-medium transition">
                + Add Income
            </button>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr x-show="isAddingIncome" class="bg-blue-50">
                            ...
                            <td class="px-4 py-3">
                                <input type="number"
                                       ...
                                       placeholder="0.00"
                                       class="w-full rounded-md border-gray-300 text-sm text-right focus:border-purple-500 focus:ring-purple-500">
                            </td>
                            <td class="px-4 py-3">
                    ...
                    <tfoot class="bg-purple-50 font-semibold">
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <div class="space-y-1">
                                    ...
                                    <label class="flex items-center text-xs">
                                        <input type="checkbox" x-model="newExpense.isGstFree" class="rounded border-gray-300 text-purple-600">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow-sm">
                ...
                <div class="text-2xl font-bold"
                    :class="netProfit >= 0 ? 'text-purple-600' : 'text-red-600'"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <textarea rows="3"
                      ...
                      class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 transition"
...
<script>
function soleTraderSection(sectionId) {
    return {
        sectionId: sectionId,
        saving: false,
        activeTab: 'all',
