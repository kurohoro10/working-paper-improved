...
<div class="space-y-6" x-data="soleTraderSection()">
    {{-- Quarter Tabs --}}
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    <input type="number"
                                           step="0.01"
                                           x-model="item.gst"
                                           class="w-full rounded-md border-gray-300 text-sm text-right bg-gray-50 focus:border-purple-500 focus:ring-purple-500"
                                           placeholder="0.00"
                                           readonly>
                                </td>
                                <td class="px-4 py-3">
