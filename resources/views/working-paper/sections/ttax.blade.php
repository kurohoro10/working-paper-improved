...
<div class="space-y-6" x-data="ttaxSection({{ $section->id }})">
    {{-- Quarter Tabs --}}
                            ...
                            <td class="px-4 py-3">
                                <div class="space-y-1">
                                    ...
                                    <label class="flex items-center text-xs">
                                        <input type="checkbox" x-model="newExpense.isGstFree" class="rounded border-gray-300 text-pink-600">
...
<script>
function ttaxSection(sectionId) {
    return {
        sectionId: sectionId,
        saving: false,
        activeTab: 'all',
